                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                                        ...
                                        <span
                                            class="badge bg-secondary bg-gradient">{{ $hasil->filter(fn($r) => count($r['rules_fired']) > 0)->count() }}
                                            barang aktif</span>
                                    </div>
                                    <div class="card-body">
                                        @if($hasil->isNotEmpty())
                                                        ...
                                                        <h2 class="accordion-header">
                                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                                ...
                                                                <span class="me-2 text-truncate"
                                                                    style="max-width: 200px;">{{ $r['barang']->{'719_nama'} }}</span>
                                                                <span class="badge bg-gradient-info ms-2">{{ count($r['rules_fired']) }} rule</span>
                                                                <span
                                                                    class="badge bg-gradient-{{ $r['rekomendasi'] > 0 ? 'success' : 'secondary' }} ms-1">
                                                                    z = {{ $r['rekomendasi'] }}
                                                                </span>
                                                            </button>
                                                        </h2>
                                                                ...
                                                                @if(count($r['rules_fired']))
                                                                    <div class="table-responsive">
                                                                        <table class="table table-sm table-hover align-middle mb-3">
                                                                            <thead class="bg-gradient-primary text-white">
                                                                                <tr>
                                                                                    <th style="width: 5%;">#</th>
                                                                                    <th style="width: 55%;">Kondisi</th>
                                                                                    <th class="text-end" style="width: 20%;">Alpha (predikat)</th>
                                                                                    <th class="text-end" style="width: 20%;">z (output)</th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                                @foreach ($r['rules_fired'] as $f)
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-xs">
                                                                                            <span
                                                                                                class="badge bg-gradient-info">{{ $f['rule']['penjualan'] }}</span>
                                                                                            <span
                                                                                                class="badge bg-gradient-warning">{{ $f['rule']['stok'] }}</span>
                                                                                            <span
                                                                                                class="badge bg-gradient-secondary">{{ $f['rule']['trend'] }}</span>
                                                                                            <span
                                                                                                class="badge bg-gradient-success">{{ $f['rule']['pasokan'] }}</span>
                                                                                        </td>
                                                                    ...
                                                                    <div class="card card-body bg-light p-2">
                                                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                                            <div>
                                                                                <small class="fw-bold">Weighted Average (Defuzzifikasi):</small>
                                                                                <div class="mt-1">
                                                                                    <span class="text-xs">Σ (alpha · z) =
                                                                                        <code>{{ round($totalAlphaZ, 2) }}</code></span>
                                                                                    <span class="mx-2">|</span>
                                                                                    <span class="text-xs">Σ alpha =
                                                                                        <code>{{ round($totalAlpha, 2) }}</code></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="text-end">
                                                                                <span class="badge bg-primary fs-6">z = {{ round($finalZ, 2) }}</span>
                                                                                <br>
                                                                                <small class="text-muted">→ dibulatkan menjadi
                                                                                    <strong>{{ $r['rekomendasi'] }} unit</strong></small>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                @else
                                                                    <div class="alert alert-light text-secondary text-xs mb-0">
                                                                        <i class="fa-regular fa-circle-info me-1"></i>
                                                                        Tidak ada rule dari 16 aturan yang terpicu — sistem memakai rumus fallback
                                                                        (kebutuhan minimum).
                                                                    </div>
                                                                @endif
                                                            </div>
